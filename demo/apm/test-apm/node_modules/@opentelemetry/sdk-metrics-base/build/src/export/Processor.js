...
class UngroupedProcessor extends Processor {
    aggregatorFor(metricDescriptor) {
        switch (metricDescriptor.metricKind) {
            ...
            case types_1.MetricKind.OBSERVABLE_COUNTER:
            case types_1.MetricKind.OBSERVABLE_UP_DOWN_COUNTER:
            case types_1.MetricKind.OBSERVABLE_GAUGE:
                return new aggregators.LastValueAggregator();
            case types_1.MetricKind.HISTOGRAM:
