...
class HistogramMetric extends Metric_1.Metric {
    constructor(name, options, _processor, resource, instrumentationLibrary) {
        super(name, options, types_1.MetricKind.HISTOGRAM, resource, instrumentationLibrary);
        this._processor = _processor;
    }
    _makeInstrument(attributes) {
        return new BoundInstrument_1.BoundHistogram(attributes, this._disabled, this._valueType, this._processor.aggregatorFor(this._descriptor));
    }
