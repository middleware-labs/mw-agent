...
var Metric = /** @class */ (function () {
     ...
     */
    Metric.prototype.bind = function (attributes) {
        var hash = hashAttributes(attributes);
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
        if (this._instruments.has(hash))
            return this._instruments.get(hash);
        var instrument = this._makeInstrument(attributes);
     ...
     * @param attributes key-values pairs that are associated with a specific metric.
     */
    Metric.prototype.unbind = function (attributes) {
