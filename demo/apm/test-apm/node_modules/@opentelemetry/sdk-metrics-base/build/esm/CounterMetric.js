...
var CounterMetric = /** @class */ (function (_super) {
    ...
    CounterMetric.prototype._makeInstrument = function (attributes) {
        return new BoundCounter(attributes, this._disabled, this._valueType, this._processor.aggregatorFor(this._descriptor));
    };
    /**
     ...
     */
    CounterMetric.prototype.add = function (value, attributes) {
