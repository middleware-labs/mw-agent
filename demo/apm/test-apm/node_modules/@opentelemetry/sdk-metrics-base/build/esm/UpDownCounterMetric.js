...
var UpDownCounterMetric = /** @class */ (function (_super) {
    ...
    UpDownCounterMetric.prototype._makeInstrument = function (attributes) {
        return new BoundUpDownCounter(attributes, this._disabled, this._valueType, this._processor.aggregatorFor(this._descriptor));
    };
    /**
     ...
     */
    UpDownCounterMetric.prototype.add = function (value, attributes) {
