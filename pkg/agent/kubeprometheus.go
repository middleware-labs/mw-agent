...
// func GetPrometheusScrapeHostAddress() string {
// 	prometheusScrapeHostAddress := os.Getenv("PROMETHEUS_SCRAPE_HOST_ADDRESS")
// 	if prometheusScrapeHostAddress == "" {
// 		return "0.0.0.0"
// 	}
// 	return prometheusScrapeHostAddress
// }

func (k *KubeAgent) UpdatePrometheusScrapeConfigs(path string) {
	jobList := CreateJobList()

	// prometheusScrapeHostAddress := GetPrometheusScrapeHostAddress()
